...
- Create Angular project with ng: `ng new codepermistracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`codepermistracker.client.esproj`).
